...
<div class="nav justify-content-center">
    <form action="<c:out value="${pageContext.request.contextPath}/book/update/${book.id}"/>">
        <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default">Set title:</span>
            <input name="title" value="<c:out value="${book.title}"/>" type="text" class="form-control titleField">
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <select name="author" class="form-select selectAuthor w-50" id="inputAuthorSelect">
                <option value="<c:out value="${book.author.id}"/>"><c:out value="${book.author.firstName} ${book.author.lastName}"/></option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <select name="category" class="form-select selectCategory w-50" id="inputCategorySelect">
                <option value="<c:out value="${book.category.id}"/>"><c:out value="${book.category.categoryName}"/></option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <select name="language" class="form-select selectLanguage w-50" id="inputLanguageSelect">
                <option value="<c:out value="${book.language.id}"/>"><c:out value="${book.language.languageName}"/></option>
            </select>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <select name="publisher" class="form-select selectPublisher w-50" id="inputPublisherSelect">
                <option value="<c:out value="${book.publisher.id}"/>"><c:out value="${book.publisher.publisherName}"/></option>
            </select>
        </div>
