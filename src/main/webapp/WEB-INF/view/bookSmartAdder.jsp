...
<div class="nav justify-content-center">
  <form method="post" action="<c:out value="${pageContext.request.contextPath}/book/addsmart/"/>">
    ...
    <input value="Try to add book." type="button" onclick="sendAddRequest(this.form)" class="w-100 btn btn-primary form-control">
  </form>
</div>
</body>
</html>
